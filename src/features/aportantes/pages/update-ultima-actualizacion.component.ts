...
@Component({
  selector: 'app-update-ultima-actualizacion',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './update-ultima-actualizacion.component.html',
})
export default class UpdateUltimaActualizacionComponent implements OnInit {
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      const response = await this.aportantesService.update(
        aportanteId,
